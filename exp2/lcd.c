...
void lcd_init(void)
{
    ...
    _delay_ms(250); // Allow power rail to stabilize during quick off/on cycles

    // Clear PCF8574 outputs to a known state
    ...
    // HD44780 8-bit software reset sequence (3x 0x03 writes)
